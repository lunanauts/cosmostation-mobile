package net.terrarebels.station.UtilLib
...
import net.terrarebels.station.UtilLib.Consts.GOOGLE_PLAY_STORE_PACKAGE_NEW
import net.terrarebels.station.UtilLib.Consts.GOOGLE_PLAY_STORE_PACKAGE_OLD
